...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2018 at 09:29 AM
...
INSERT INTO `list_pengiriman_besar` (`IDListPengirimanBesar`, `IDKurir`, `IDCabangTujuan`, `IDCabangAsal`, `isSend`, `created_on`, `trash`) VALUES
(23, 9, 2, 1, 'N', '1531118671653', 'N');
...
(12, 2, 'Combro', '1530993607948292', 'Ricko', 'Jl. Laksamana Martadinata, Kotalama, Kedungkandang, Kota Malang, Jawa Timur, Indonesia', '949494949499', 'Dili', 'Cipondoh, Tangerang City, Banten, Indonesia', '-6.75', '106.75', '9393939393', '10', 'REG', 'BRG', '100000', '1530993669213', 'Y', 'N'),
...
(14, 2, '112312312', '1531078102885916', 'dili', 'Jl. Casablanca, RT.7/RW.11, Menteng Dalam, Tebet, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta, Indonesia', '23423423', 'kotaa', 'Sunter Agung, Tanjung Priok, North Jakarta City, Jakarta, Indonesia', '-6.75', '106.75', '2323423423', '10', 'REG', 'BRG', '100000', '1531078160998', 'Y', 'N'),
...
--
ALTER TABLE `detail_pengiriman_besar`
  MODIFY `IDDetailPengirimanBesar` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `list_pengiriman_besar`
  MODIFY `IDListPengirimanBesar` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `log_tracking`
--
ALTER TABLE `log_tracking`
  MODIFY `IDLog` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
--
-- AUTO_INCREMENT for table `paket_barang`
--
ALTER TABLE `paket_barang`
  MODIFY `IDPaket` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `penerimaan_paket`
  MODIFY `IDPenerimaan` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
